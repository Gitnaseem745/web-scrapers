// 📚 Level 3B Project: Deep Blog Scraper with Pagination and Content Extraction
// This scraper collects all article metadata (title, description, link) from
// sitename.com, then visits each article page to extract full HTML content.
// Includes pagination and article limit feature. Built using Puppeteer.
const puppeteer = require('puppeteer');
const fs = require('fs');

const siteUrl = "https://www.sitename.com/articles/";
